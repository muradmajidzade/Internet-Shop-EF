        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Coupon_DiscountPercent", "DiscountPercent >= 1 AND DiscountPercent <= 100");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Order_Status", "Status = 'Pending' OR Status = 'Paid' OR Status = 'Shipped' OR Status = 'Delivered' OR Status = 'Cancelled'");
